...
match whattorun:
    ...
    case "pse":
        print(write_api.write(config['pse']['influxdb_bucket'], config['influxdb']['organization'], pse_new_api.get_report_json((datetime.now() + timedelta(config['pse']['time_delta']))), write_precision='s'))
    case _:
        print("Unown command")
